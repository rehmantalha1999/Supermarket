...
<head>
  ...
  <title>Customer Login | LAMDAS</title>
      ...
      <div class="navbar">
        <div class="navbar-login">
          ...
          <div class="form">
            ...
            <div class='dont'>
              <p>Don't have an account? <a href="./csignup.php">Sign Up here</a></p>
              <a href="../market" class="a-btn">Marketer Login</a>
            </div>
          </div>
          <hr class="hr-two" />
          <div class="footer">
